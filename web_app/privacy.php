...
<div class="row content">
    <div class="large-12 columns">
        <div class="card" style="padding:40px;">
            <center><h4>Privacy Policy</h4></center><br>
            This Privacy Policy governs the manner in which Utopia Developers collects, uses, maintains and discloses information collected from users (each, a "User") of the <a href="http://www.utopiadevelopers.com">http://www.utopiadevelopers.com</a> website ("Site"). This privacy policy applies to the Site and all products and services offered by Utopia Developers.<br><br>
            ...
            Utopia Developers may collect and use Users personal information for the following purposes:<br>
            <ul style="margin-top:5px;margin-left:19px;">
            ...
            Utopia Developers has the discretion to update this privacy policy at any time. When we do, we will post a notification on the main page of our Site, revise the updated date at the bottom of this page and send you an email. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.<br><br>
            ...
            If you have any questions about this Privacy Policy,<br>the practices of this site, or your dealings with this site,<br>please contact us at:
            <a href="mailto:utopiadevelopers@gmail.com">utopiadevelopers@gmail.com</a>
            <br><br>This document was last updated on June 15, 2014<br><br>
        </div>
    </div>
</div>
<?php
